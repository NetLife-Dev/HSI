    ...
    <footer className="bg-slate-50 dark:bg-slate-900 border-t border-slate-200 dark:border-slate-800 pt-16 pb-8">
      <div className="container mx-auto px-4 grid grid-cols-1 md:grid-cols-2 lg:grid-cols-4 gap-12">
        ...
        <div className="space-y-4">
          ...
          <ul className="flex flex-col gap-3 text-sm text-slate-600 dark:text-slate-300">
            ...
            <li><Link href="/busca" className="hover:text-primary hover:underline">Novidades</Link></li>
        ...
        <div className="space-y-4">
          ...
          <ul className="flex flex-col gap-3 text-sm text-slate-600 dark:text-slate-300">
            ...
            <li><Link href="/privacidade" className="hover:text-primary hover:underline">Privacidade</Link></li>
        ...
        {/* Contact */}
        <div className="space-y-4">
          <h4 className="font-bold text-sm uppercase tracking-widest text-slate-400">Contato Directo</h4>
          <ul className="flex flex-col gap-3 text-sm text-slate-600 dark:text-slate-300">
            ...
            <li className="flex items-center gap-3">
              ...
              <span className="leading-tight">São Paulo, Brasil</span>
            </li>
          </ul>
        </div>
      </div>
      ...
      <div className="container mx-auto px-4 mt-16 pt-8 border-t border-slate-200 dark:border-slate-800 flex flex-col md:flex-row items-center justify-between gap-4 text-[10px] text-slate-400 font-semibold uppercase tracking-widest">
        ...
        <div className="flex items-center gap-1">
          Desenvolvido com <span className="text-destructive">❤</span> por <span className="text-slate-900 dark:text-slate-100 italic">NetLife Cloud</span>
        </div>
      </div>
    </footer>
  )
