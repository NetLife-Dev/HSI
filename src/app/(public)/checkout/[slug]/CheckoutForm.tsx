  ...
  return (
    <div className="space-y-12">
      ...
      <section className="bg-surface-elevated rounded-[2.5rem] p-8 md:p-10 border border-border-subtle shadow-sm space-y-6">
         ...
         <div className="space-y-4">
            ...
            <p className="text-sm text-text-tertiary leading-relaxed">
               Ao prosseguir, você concorda em cumprir as regras da casa estabelecidas pelo proprietário: <span className="italic font-medium text-text-secondary">{property.rules || 'Tratar o espaço com respeito.'}</span>
            </p>
         </div>
      </section>
      ...
      <div className="pt-4 flex flex-col gap-4">
         ...
         >
            {loading ? 'Preparando Checkout...' : 'Confirmar e Ir para Pagamento'}
         </Button>
         <div className="flex items-center justify-center gap-2 text-xs text-text-tertiary font-medium">
